...
//  Set Microsoft App Client ID via UserDefaults key "Lokalo.oneDrive.clientID".
//
...
enum OneDriveOAuth {
    ...
    static var clientID: String {
        UserDefaults.standard.string(forKey: "Lokalo.oneDrive.clientID") ?? ""
    }

    static let scope = "Files.Read offline_access User.Read"

    static let redirectURI = "it.klincov.lokalo://oauth-callback"
    static let callbackScheme = "it.klincov.lokalo"
