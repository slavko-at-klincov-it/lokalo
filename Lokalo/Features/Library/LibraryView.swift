...
struct LibraryView: View {
    ...
    @AppStorage("Lokalo.libraryGrouping") private var groupingRaw = ModelGrouping.publisher.rawValue
    @AppStorage("Lokalo.librarySort") private var sortRaw = ModelSort.paramsAsc.rawValue
...
// SwiftUI #Preview removed: LibraryView depends on the full LokaloApp store
