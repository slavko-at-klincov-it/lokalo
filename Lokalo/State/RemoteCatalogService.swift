...
//  (`Lokalo/Resources/models.json` + `ModelCatalog.loadManifest`) makes
...
final class RemoteCatalogService {
    ...
    static let remoteURL = URL(
        string: "https://raw.githubusercontent.com/slavko-at-klincov-it/lokalo/main/Lokalo/Resources/models.json"
    )!
