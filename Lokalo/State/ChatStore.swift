...
final class ChatStore {
    ...
    /// Strong references — owned by LokaloApp's dependency graph. Forming a
    ...
    /// If the app was launched with `-LokaloAutoTestPrompt "..."`, fire off
    ...
    func runAutoTestPromptIfPresent() async {
        ...
        guard let idx = args.firstIndex(of: "-LokaloAutoTestPrompt"),
    ...
    func send(_ text: String) {
        ...
        let userProfile = includeProfile
            ? (UserDefaults.standard.string(forKey: "Lokalo.userProfile") ?? "")
            : ""
