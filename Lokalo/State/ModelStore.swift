...
final class ModelStore {
    ...
    func bootstrap() async {
        ...
        installedIDs = found
        if let savedActive = UserDefaults.standard.string(forKey: "Lokalo.activeModelID"),
           found.contains(savedActive) {
            activeID = savedActive
        } else if let first = found.sorted().first {
            activeID = first
            UserDefaults.standard.set(first, forKey: "Lokalo.activeModelID")
        }
        refreshDiskUsage()
    }
    ...
    func setActive(_ id: String) {
        ...
        activeID = id
        UserDefaults.standard.set(id, forKey: "Lokalo.activeModelID")
    }
    ...
    func remove(_ id: String) {
        ...
        if activeID == id {
            ...
            if let a = activeID {
                UserDefaults.standard.set(a, forKey: "Lokalo.activeModelID")
            } else {
                UserDefaults.standard.removeObject(forKey: "Lokalo.activeModelID")
            }
        }
        refreshDiskUsage()
    }
