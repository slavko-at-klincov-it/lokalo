...
struct LicensesView: View {
    private let entries: [LicenseEntry] = [
        ...
        .init(title: "Qwen 2.5",
              kind: "Apache 2.0 / Qwen Research License",
              summary: "By Alibaba Cloud. Apache 2.0 for the smaller variants; Qwen Research License for the 3B variant — non-commercial research use unless commercial license obtained.",
